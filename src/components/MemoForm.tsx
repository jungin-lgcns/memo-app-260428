              ...
              {contentTab === 'write' ? (
                <div>
                  ...
                  <textarea
                    ...
                    className="placeholder-gray-400 text-gray-700 w-full px-3 py-2 border border-gray-300 rounded-b-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"
                    placeholder="메모 내용을 입력하세요 (마크다운 문법을 사용할 수 있습니다)"
                    rows={8}
                    required
                  />
                </div>
              ) : (
                <div className="min-h-[13.5rem] w-full px-3 py-2 border border-gray-200 rounded-lg bg-gray-50 overflow-y-auto">
